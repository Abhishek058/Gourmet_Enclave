      ...
      <div className="chefCont flex flex-col p-5">
        ...
        <div className="chefWord flex flex-col justify-center py-7">
          ...
          <p className="py-12 font-roboto text-gray-400">
            ...
            exquisite dishes that elevate your dining experience. With years of
            expertise and an unwavering commitment to quality, they infuse each
            creation with innovation and passion. From savory starters to
            indulgent desserts, our chefs blend global influences into our menu,
            offering a unique fusion of flavors.
          </p>
